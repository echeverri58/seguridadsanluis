# -*- coding: utf-8 -*-
"""Lesiones_accidentes_transito.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1Eb7ZIrqmyWKtMfniJexqrNsyRmHBCEWi
"""

# GRAFICA POR AÑO DE LESIONES POR ACCIDENTES DE TRANSITO EN SAN LUIS ANTIOQUIA
...
plt.xlabel('Año')
plt.ylabel('Cantidad')
plt.title('Lesiones por accidentes de transito en San Luis Antioquia por año')
